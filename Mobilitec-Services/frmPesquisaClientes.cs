...
namespace Mobilitec_Services
{
    public partial class frmPesquisaClientes : Form
    {
        ...
        public void inclementandoPesquisa()
        {
            ...
            conn.CommandText = "insert into tbClientes (nome) values(@nome)";
        ...
        //pesquisa por código
        public void  pesquisaPorCodigo(int codCli)
        {
            MySqlCommand conn = new MySqlCommand();
            conn.CommandText = "select * from tbClientes where codCli = " + codCli + ";";
            conn.CommandType = CommandType.Text;
