...
namespace Mobilitec_Services
{
    public partial class frmClientes : Form
    {
        ...
        public void alterandoInf(int codCli)
        {
            MySqlCommand conn = new MySqlCommand();
            conn.CommandText = "update tbClientes set nome = '@nome' , email = '@email' , cpf = '@cpf', telefone = '@telefone' , sexo , = @sexo , endereco = @endereco , numero = @numero , cep = @cep , bairro = @bairro , cidade = @cidade , estado = @estado where codCli = "+codCli+";";
        ...
        {
            MySqlCommand conn = new MySqlCommand();
            conn.CommandText = "insert into tbClientes (nome,email,cpf,telefone,sexo,endereco,numero,cep,bairro,cidade,estado)" +
            ...
            conn.Parameters.Add("@cpf", MySqlDbType.VarChar, 14).Value = mkdCPF.Text;
            conn.Parameters.Add("@telefone", MySqlDbType.VarChar, 15).Value = mkdTelefone.Text;
            conn.Parameters.Add("@sexo", MySqlDbType.VarChar, 10).Value = cbbSexo.Text;
            conn.Parameters.Add("@endereco", MySqlDbType.VarChar, 100).Value = txtEndereco.Text;
            conn.Parameters.Add("@numero", MySqlDbType.VarChar, 10).Value = txtNumero.Text;
            conn.Parameters.Add("@cep", MySqlDbType.VarChar, 9).Value = mkdCEP.Text;
            conn.Parameters.Add("@bairro", MySqlDbType.VarChar, 100).Value = txtBairro.Text;
        ...
        {
            frmPesquisaClientes abrir = new frmPesquisaClientes();
            abrir.Show();
            this.Hide();
        }
        ...
        private void btnTestarCEP_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            MySqlCommand conn = new MySqlCommand();
            conn.CommandText = "select * from tbClientes where nome like '%" + nome + "%';";
            conn.CommandType = CommandType.Text;
            conn.Connection = Conexao.obterConexao();
